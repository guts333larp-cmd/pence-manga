...
* `pencemangaapp` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `pencemanga.app` - executable or bundle name on disk.
* `pencemanga.app` - display name shown in window titles and about app dialogs.
